...
export default class AddNewB extends Component {
  ...
  addNew = (event) => {
    this.props.addNew("budgets", this.state.name, this.state.total)
  ...
  render() {
    return (
      <div className="input-group mb-3">
        <input value={this.state.name} onChange={this.handleChange1} type="text" placeholder="Budget" className="form-control"></input>
