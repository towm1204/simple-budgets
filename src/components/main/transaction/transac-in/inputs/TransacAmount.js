  ...
  render() {
    return (
      <div className="input-group mb-3" id="transacInAmount">
        ...
        <input value={this.state.value} onChange={this.handleChange} type="text"  placeholder="0.00" className="form-control" aria-label= "Insert amount" htmlFor="EnterAmount" required></input>
      </div>
    );
  }
}
