  ...
  render() {
    return (
      <div className="input-group mb-3" id="transacInDesc">
        ...
        <input value={this.state.value} onChange={this.handleChange} type="text" placeholder="Winco, phonebill, etc." className="form-control" aria-label= "Insert Description" htmlFor="EnterDescription"></input>
      </div>
    );
  }
}
